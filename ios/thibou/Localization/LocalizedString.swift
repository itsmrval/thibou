...
enum LocalizedKey: String, CaseIterable {
    ...
    case shortcutsSubtext = "Components/Home.shortcuts_subtext"
    case myInhabitants = "Components/Home.my_inhabitants"
    case myInhabitantsSubtext = "Components/Home.my_inhabitants_subtext"
    ...
    case manageIsland = "Components/Island.manage_island"
    case favoriteResidents = "Components/Island.favorite_residents"
    case favorites = "Components/Island.favorites"
    case islandResidents = "Components/Island.island_residents"
    case islandResidentsSubtext = "Components/Island.island_residents_subtext"
    case addFavorite = "Components/Island.add_favorite"
    case addResident = "Components/Island.add_resident"
    case addToFavorites = "Components/Island.add_to_favorites"
    case removeFromFavorites = "Components/Island.remove_from_favorites"
    case selectVillager = "Components/Island.select_villager"
    case selectFromAll = "Components/Island.select_from_all"
    case noResidentsTitle = "Components/Island.no_residents_title"
    case noResidentsDescription = "Components/Island.no_residents_description"
    case noFavoritesTitle = "Components/Island.no_favorites_title"
    case noFavoritesDescription = "Components/Island.no_favorites_description"
    case defineFavorite = "Components/Island.define_favorite"
    case maxResidentsReached = "Components/Island.max_residents_reached"
    case maxFavoritesReached = "Components/Island.max_favorites_reached"
    case mustBeResident = "Components/Island.must_be_resident"
    case removeFromIsland = "Components/Island.remove_from_island"
    case markAsFavorite = "Components/Island.mark_as_favorite"
    case unmarkAsFavorite = "Components/Island.unmark_as_favorite"
    case addToIsland = "Components/Island.add_to_island"
    case updateResidents = "Components/Island.update_residents"
    case updateFavorites = "Components/Island.update_favorites"
    case loadingIsland = "Components/Island.loading_island"
    case errorLoadingIsland = "Components/Island.error_loading_island"
    case errorSaving = "Components/Island.error_saving"
    case islandUpdated = "Components/Island.island_updated"
    case confirmRemoveResident = "Components/Island.confirm_remove_resident"
    case confirm = "Components/Island.confirm"
    case alreadyOnIsland = "Components/Island.already_on_island"
    case alreadyFavorite = "Components/Island.already_favorite"
    ...
    case islandViewMoreDetails = "Components/Island.view_more_details"
    case manageVillager = "Components/Island.manage_villager"
    case likes = "Components/Island.likes"
    case removeFromLikes = "Components/Island.remove_from_likes"
    case updateLikes = "Components/Island.update_likes"
    case parameters = "Components/Auth.parameters"
    case parametersSubtext = "Components/Auth.parameters_subtext"
    ...
    case confirmYourIdentity = "Components/Auth.confirm_your_identity"
    case confirmYourIdentityDescription = "Components/Auth.confirm_your_identity_description"
    case signInWithPassword = "Components/Auth.sign_in_with_password"
    case appleAccountLinkedSuccessfully = "Components/Auth.apple_account_linked_successfully"
    case appleAccountUnlinkedSuccessfully = "Components/Auth.apple_account_unlinked_successfully"
    case definePassword = "Components/Auth.define_password"
    case updateMyPassword = "Components/Auth.update_my_password"
    case passwordDefinedSuccessfully = "Components/Auth.password_defined_successfully"
    case passwordUpdatedSuccessfully = "Components/Auth.password_updated_successfully"
